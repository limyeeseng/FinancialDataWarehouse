...
This repository is an example of ETL workflows built in SQL Server Integration Services (SSIS). The workflow moves data from Data Source to Destination:   

### 1. **Database table to another table**
